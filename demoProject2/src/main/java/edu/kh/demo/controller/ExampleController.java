...
class ExampleController {
	 ...
	 * - ModelAndView : 데이터 전달 + forward할 피일 경로 지정
	 * 
	 * */
	...
	public String ex1(HttpServletRequest req, Model model) {
		...
		// 복수 값(배열, List)Model을 이 용해서 html로 전달
		...
		stdList.add(new Student("1111", "김일번", 21));
		stdList.add(new Student("2222", "최이번", 22));
		stdList.add(new Student("3333", "심삼번", 23));
	...
	public String ex2(Model model) {
		// Model : Spring에서 데이터 전달용 객체(기본 : request scope)
	...
	public String ex4(Model model){
		...
		Student std = new Student("12345", "잠만보", 30);
