...
public class ParameterController {
	...
	@PostMapping("test1") // /param/test1 POST 방식으로 매핑
	public String paramTest1(HttpServletRequest req) {
		...
		// Integer.parseInt의 기능
		// 전달되는 값들은 모두 String,
		// 숫자로만 이루어진 String을 int로 변환 가능하게함
	...
	public String paramTest2(
		...
		@RequestParam("price") int price, // 데이터 parsing 알아서 해준다
		@RequestParam(value = "publisher", required = false, defaultValue = "교문보고") String publisher
		// required = false -> 필수 값은 아니라는 뜻
	...
	public String paramTest3(
		...
		// Map(K:V) 같은 K값들의 중복 저장 안되고 덮어쓰기가 됨
